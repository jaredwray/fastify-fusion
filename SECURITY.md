...
- The release workflow packs the package and stages it with `pnpm stage publish` over OIDC. npmjs.com trusted publishing is **stage-only**. Staged versions are reviewed in Drydock and promoted with 2FA. The package requires 2FA and disallows tokens. There are no npm tokens in Actions.
